    ...
    <div class="custom_container">
        ...
        <div class="vm-wrapper">
            ...
            <div class="vm-card">
                ...
                <p class="vm-desc">
                    The vision of this clinical psychology internship is to create an environment that:
                </p>
            ...
            <div class="vm-card">
                ...
                <p class="vm-desc">
                    This internship for clinical psychology students aims to empower the future of mental health by:
                </p>
...
Currently pursuing / finished Masters in Clinical Psychology,
must appear for screening interview
</li>

<li>
<strong>Key Learnings:</strong>
Case history intake, report writing,
diagnosis creation, administration of rating scales
and IQ tests
</li>
...
<strong>Eligibility:</strong>
Currently pursuing / finished Masters in Clinical Psychology
and has passed Level One in the internal assessment
</li>

<li>
<strong>Key Learnings:</strong>
Psychometric assessments (personality, developmental,
neuropsychology), administration, scoring and reporting
</li>
...
<li>
<strong>Eligibility:</strong>
Completed Masters in Clinical Psychology
and passed Level Two in the internal assessment
</li>

<li>
<strong>Key Learnings:</strong>
Basic counselling skills, psychoeducation,
parent counselling and crisis intervention
</li>
...
<p class="table-note">
*Eligible candidates will receive an email from the internship coordinators to set up a date and time for a screening interview.
</p>

<p class="table-note">
*If selected for the internship, candidates will receive a confirmation email along with the payment details and further instructions.
</p>
...
<a href="https://forms.gle/kutdx7J5BpMr15gr8"
   target="_blank"
...
<p class="cta-text">
Learn more about how we shape
<strong>Psychologists in the Making</strong>
through our hands-on internship program.
</p>
...
<p>
Minimum <strong>10% off</strong> for a group of four people
</p>
...
<h3 class="coordinator-name">
Dr. Sumedha Singh
</h3>

<p class="coordinator-info">
...
What does the Mind-Rewire Clinical Psychology Internship in Pune offer?
</h2>

<p class="offer-desc">
Widely recognized as the best internship for psychology students in India, our program is divided into three levels which provide hands-on opportunities in
</p>

<ul class="offer-list">

<li>
Ethical case history, mental status examination, and diagnostic skills
</li>

<li>
Training in administration, scoring, and reports of psychometric assessments
</li>

<li>
Training in basic counselling skills, psychoeducational, and crisis intervention
</li>

</ul>

<p class="offer-note">
*Consent from the client will be taken beforehand
</p>
...
<p class="level-intro">
The aim of <span>Level I</span> (Junior Internship) is to equip the intern with
</p>
...
<p class="level-intro">
The aim of <span>Level II</span> (Senior Internship) is to equip the intern with the skills to administer, score and report
</p>
...
<p class="level-intro">
The aim of <span>Level III</span> (Apprenticeship) is to equip the intern with
</p>
...
<p class="level-note">
*A letter of experience will be provided at the end of each level.
</p>
...
How do I benefit from interning at Mind Rewire?
</h2>

<p class="benefits-desc">
Here are all the benefits you can expect by enrolling in the finest clinical psychology internship in India
</p>

<ul class="benefits-list">

<li>
A letter of clinical experience for further job/academic opportunities
</li>

<li>
Guidance and mentorship from licensed (RCI) <strong>clinical psychologists</strong>
</li>

<li>
Ethical and holistic approach to practical training in the clinical skills required in mental health
</li>

<li>
Access to academic and clinical reading material for various entrance exams
</li>

<li>
Participation in group discussions, case presentations, and lecture
</li>
...
{{-- ============================================================
     BROCHURE MODAL  —  drop this anywhere inside internship.blade.php
     Replace the existing modal + script block with this entire snippet
     ============================================================ --}}

<!-- ========================= DOWNLOAD BROCHURE BUTTON ========================= -->
{{-- Keep your existing button exactly as-is, no change needed there --}}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function validateForm() {
        ...
        if (!name) {
            showError("b_name", "err_name", "Please enter your full name.");
            valid = false;
        } else if (name.length < 2) {
            showError("b_name", "err_name", "Name must be at least 2 characters.");
            valid = false;
        }

        if (!email) {
            showError("b_email", "err_email", "Please enter your email address.");
            valid = false;
        } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
            showError("b_email", "err_email", "Please enter a valid email address.");
            valid = false;
        }

        if (!phone) {
            showError("b_phone", "err_phone", "Please enter your phone number.");
            valid = false;
        } else if (!/^[\d\s\+\-\(\)]{7,15}$/.test(phone)) {
            showError("b_phone", "err_phone", "Please enter a valid phone number.");
            valid = false;
        }
    ...
    document.getElementById("b_name").addEventListener("blur", function() {
        if (!this.value.trim()) showError("b_name", "err_name", "Please enter your full name.");
    ...
    document.getElementById("b_email").addEventListener("blur", function() {
        ...
        if (!v) showError("b_email", "err_email", "Please enter your email address.");
        else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v)) showError("b_email", "err_email", "Please enter a valid email address.");
    ...
    document.getElementById("b_phone").addEventListener("blur", function() {
        const v = this.value.trim();
        if (!v) showError("b_phone", "err_phone", "Please enter your phone number.");
        else if (!/^[\d\s\+\-\(\)]{7,15}$/.test(v)) showError("b_phone", "err_phone", "Please enter a valid phone number.");
        ...
        .then(function (res) {
            ...
            if (res.status === 422) {
                return res.json().then(function (data) {
                    // Map Laravel errors back to fields
