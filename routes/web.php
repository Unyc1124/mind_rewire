...
/*
|--------------------------------------------------------------------------
| MULTI PRODUCT SELECTION (SESSION BASED)
|--------------------------------------------------------------------------
*/

// Update quantity (AJAX from product page)
Route::post('/product/select', [App\Http\Controllers\ProductSelectionController::class, 'update'])
    ->name('product.select');

// View selected products page (optional)
Route::get('/checkout-selected', [CheckoutController::class, 'selected'])
    ->name('checkout.selected');
